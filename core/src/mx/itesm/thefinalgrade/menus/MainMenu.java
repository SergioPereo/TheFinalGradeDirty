...
public class MainMenu extends Menu {
    ...
    protected void createMenu() {
        ...
        creditsBtn.setPosition(ANCHO/3,100);
        ...
        exitBtn.setPosition(ANCHO/3, 20);
        ...
        optionBtn.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y){
                super.clicked(event, x, y);
                game.setScreen(new OptionsMenu(game, "Fondo_StartMenu.png")); // Forums tells that this lane has to follow Gdx.app.exit because some things remain open in task manager
            }
        });
